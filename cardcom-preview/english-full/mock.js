...
(function () {
  ...
  fetch("../../templates/cardcom/redirect-normal/english-full/iframe.html")
    .then(function (res) {
    ...
    .catch(function (err) {
      document.getElementById("checkout-root").textContent =
        "Could not load templates/cardcom/redirect-normal/english-full/iframe.html. Serve the repo root so the fetch path works. " +
        err;
    });
})();
